...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="vendors/fontawesome.min.css">
                               ...
                               <div class="col-md-3">
                                   <div class="blog_info text-right">
                                        ...
                                        <ul class="blog_meta list_style">
                                            ...
                                            <li><a href="#">12 Jul, 2019<i class="lnr lnr-calendar-full"></i></a></li>
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="blog-single.html"><h2>暑期桌遊營</h2></a>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="blog-single.html"><h2>中秋節活動</h2></a>
                                            <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                            <a href="blog-single.html" class="view_btn button_hover">View More</a>
                                        </div>
                                    </div>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="blog-single.html"><h2>聖誕節</h2></a>
                                            <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                            <a href="blog-single.html" class="view_btn button_hover">View More</a>
                                        </div>
                                    </div>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="blog-single.html"><h2>彩虹親子座談會</h2></a>
                                            <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                            <a href="blog-single.html" class="view_btn button_hover">View More</a>
                                        </div>
                                    </div>
                               ...
                               <div class="col-md-3">
                                ...
                                <div class="col-md-9">
                                    <div class="blog_post">
                                        ...
                                        <div class="blog_details">
                                            <a href="blog-single.html"><h2>屬靈家長課程</h2></a>
                                            <p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a fraction.</p>
                                            <a href="blog-single.html" class="view_btn button_hover">View More</a>
                                        </div>
                                    </div>
                    ...
                    <div class="col-lg-4">
                        <div class="blog_right_sidebar">
                            ...
                            <aside class="single_sidebar_widget popular_post_widget">
                                ...
                                <div class="media post_item">
                                    <img src="img/blog/post4.jpg" alt="post">
                                    <div class="media-body">
