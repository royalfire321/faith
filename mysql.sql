...
CREATE TABLE new_friend (
  uid mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '會員編碼',
  name varchar(255) NOT NULL COMMENT '姓名',
  gender enum('F','M') NOT NULL DEFAULT 'F' COMMENT '性別',
  age year(4) NOT NULL COMMENT '年齡層',
  tel varchar(255) NOT NULL COMMENT '電話',
  email varchar(255) NOT NULL COMMENT '信箱',
  christian enum('Y','N') NOT NULL DEFAULT 'Y' COMMENT '信仰',
  opinion text NOT NULL COMMENT '意見',
  PRIMARY KEY (`uid`)
